...
def extract_interview_context(current_state: Dict, input_state: Dict) -> Dict[str, Any]:
    ...
    market = (
        current_state.get("market_context")
        or input_state.get("market_context")
        or current_state.get("market")
        or input_state.get("market")
        or {}
    )
    ...
    if market.get("top_vacancies"):
        first_vacancy = market["top_vacancies"][0]
