    ...
    async def search_vacancies(
        ...
        try:
            ...
            search_response = await self.client.query_points(
                ...
                limit=20,                               # количество вакансий для поиска
                with_payload=True,
            ...
            for vac in vacancies:
                ...
                for skill in skills:
                    ...
                    if payload.get("grade"):
                        skill_stats[key]["grades"].append(payload["grade"])
                    if payload.get("title"):
                        skill_stats[key]["titles"].append(payload["title"])
