...
def get_extraction_chain(text: str):
    ...
    prompt = ChatPromptTemplate.from_template("""
        Ты — эксперт по анализу резюме в сфере Machine Learning и Data Science.
        ...
        4. Оцени 'grade' (Junior, Middle, Senior, Lead) на основе стажа и сложности проектов.
        5. 'skills' — это единый список, куда должны попасть: языки программирования, фреймворки, базы данных и инструменты.
