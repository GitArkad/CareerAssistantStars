...
- если город и страна не указаны ищи по всем вакансиям 
...
ЗАПРЕЩЕНО:
- Вызывать один инструмент внутри другого
- Передавать результат одного инструмента как аргумент другого

ПРАВИЛЬНО:
- Сначала вызови analyze_market_context
- Дождись результата (он появится в market_context)
- Потом используй эти данные БЕЗ повторных вызовов инструментов
